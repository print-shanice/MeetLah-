...
2. Fill in event details (title, time, location)
3. Click "Add Event"
4. Events will appear color-coded based on the member

### Creating Meetups
1. Click "Create Meetup" in the sidebar
2. Select a date and time when everyone is free
3. Add location and details
4. All calendar members will be automatically added as participants

### Tracking Attendance
1. After a meetup ends, click on the meetup event
2. Mark who was on time and who was late
3. The system will track attendance automatically

### Assigning Punishments
1. After marking attendance, late participants will be identified
2. Click "Assign Random Punishments"
3. Each latecomer gets a randomly selected fun punishment
4. Punishments can be marked as completed

### Maintaining Streaks
- Meet at least once every month to maintain your streak
